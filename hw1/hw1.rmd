...
<!--   Yes I did. My GitHub handle is @bryanlin24 -->
...
awk '$3==0 {$3=""} $4==0 {$4=""} $5==1 {$5="M"} $5==2 {$5="F"} $6==0 {$6=""}1' /home/m280-data/hw1/merge-geno.fam | gawk 'BEGIN {OFS = ","} {print}' | sed 's/T2DG//g' > mendel_ped.txt
