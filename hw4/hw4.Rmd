...
#20,063/22,000 = 0.0912
 ...
 gg1 + 
   ...
   geom_line(data = labs2, aes(x = long2, y = lat2), size = size2, color = "black") + 
...
```{r}
#Visualize predictions for 2008
...
```
  ...
  This map represents the top 10 destinations from the airport MSP. I found it interesting how MSP is one of the top 10 busiest airports and so wanted to see what the most popular destinations from MSP are. The map above shows the most popular destinations are on the West coast (i.e. California, Nevada, Arizona and Washington state).