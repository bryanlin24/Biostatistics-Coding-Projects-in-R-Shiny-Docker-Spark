...
```{r, eval = FALSE}
#calculate rmse by doing sqrt(predicted-observed/n)
test_data1 <- test_data %>% 
  select(arrdelay, prediction) %>% 
  mutate(test_data, mse = (prediction-arrdelay)^2)
  
#%>% 
#  mutate(test_data, mse = prediction-arrdelay)
